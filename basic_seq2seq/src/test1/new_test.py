...
def build_model2():
    ...
    decoder_lstm = LSTM(latent_dim, return_sequences=True, return_state=True, name="decoder_lstm1")
    decoder_outputs, _, _ = decoder_lstm(embedding_layer2,
                                         initial_state=encoder_states)

    decoder_lstm2 = LSTM(latent_dim, return_sequences=True, name="decoder_lstm2")
    ...
    model.fit([input_data, target_data], target_data, epochs=1)  # , batch_size=128)

def build_model3():
    encoder = Sequential()
    encoder.add(LSTM(100))
