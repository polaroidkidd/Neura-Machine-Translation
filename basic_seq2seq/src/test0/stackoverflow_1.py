...
model.fit_generator(serve_batch_perfomance(input_data, target_data), 1, epochs=epochs, verbose=2,  # workers=4,
                    callbacks=[tbCallBack])

model.save(os.path.join(BASIC_PERSISTENT_DIR, MODEL_DIR, 'stack1.model'))
